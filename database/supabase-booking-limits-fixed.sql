-- Supabase-compatible Booking Limits Migration (Fixed RLS)
...
-- DISABLE Row Level Security for these admin tables
-- This is simpler for backend operations
ALTER TABLE daily_limits DISABLE ROW LEVEL SECURITY;
ALTER TABLE system_settings DISABLE ROW LEVEL SECURITY;

-- Alternatively, if you want RLS enabled, use these policies instead:
-- ALTER TABLE daily_limits ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE system_settings ENABLE ROW LEVEL SECURITY;
-- 
-- CREATE POLICY "Allow service_role full access to daily_limits" ON daily_limits
--   FOR ALL TO service_role USING (true) WITH CHECK (true);
-- 
-- CREATE POLICY "Allow service_role full access to system_settings" ON system_settings
--   FOR ALL TO service_role USING (true) WITH CHECK (true);

-- Grant permissions to service role (this is the key fix)
