...
interface AnalyticsData {
  ...
  serviceBreakdown: {
    standard: ServiceBreakdownItem;
    premium: ServiceBreakdownItem;
    traditional_japanese?: ServiceBreakdownItem;
  };
  geoInsights: Array<{ postcode: string; count: number; revenue: number }>;
          ...
          <>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <div className="space-y-2">
                  {analytics.geoInsights.slice(0, 5).map((area) => (
